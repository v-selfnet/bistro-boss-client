        ...
        <footer className='mt-10'>
            <div className="footer bg-neutral text-neutral-content">
                ...
                <div className="items-center text-left p-10 bg-neutral w-full">
                    ...
                    <span className="footer-title"><small>Join with us</small></span>
            ...
            <div className="items-center text-center p-4 bg-slate-600 text-neutral-content">
            
                <p><small>&copy;&nbsp; Bistro Boss {currentYear} - All right reserved</small></p>
            </div>
        </footer>
    );
};
